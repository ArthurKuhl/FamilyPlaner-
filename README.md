...
- `termine.html` – Termine-Modul: Kalender- und Agendaansicht, Wiederholungen, Filter nach Person (Familie/Mama/Papa/Lev/Malia), Erinnerungen per Browser-Benachrichtigung (15 Min. bis 1 Tag vorher, gleiche Einschränkung wie bei der Wasser-Erinnerung: funktioniert solange die App im Hintergrund geöffnet ist), .ics-Export zum Importieren aller Termine in Google/Apple Kalender
