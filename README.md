...
- `einkauf.html` – Einkauf-Modul: mehrere Einkaufslisten, Kategorien-Gruppierung, Mengen-Parsing bei der Schnelleingabe (z.B. „500g Mehl“), Favoriten-Vorschläge, automatisches Zusammenführen gleicher offener Posten (z.B. „300g Mehl“ + „200g Mehl“ → „500g Mehl“; nur bei gleicher Einheit), Kennzeichnung wer ein Produkt hinzugefügt hat (per „Ich bin“-Auswahl, nutzt die gemeinsame Personenliste aus `personen.js`)
