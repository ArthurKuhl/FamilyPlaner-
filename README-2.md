...
Eine feature-reiche, offline-fähige Familien-/Lebensplaner-App als Progressive Web App (PWA) – läuft direkt im Browser oder installiert auf dem Smartphone-Homescreen. Garten und Termine sind bereits vollständig ausgebaute Bereiche; weitere Bereiche (Gesundheit & Sport, Einkauf, Kochen & Backen, Gaming, ...) folgen als eigenständige Module in derselben App-Hülle.
